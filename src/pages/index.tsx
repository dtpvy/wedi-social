            ...
            <div className="w-full sm:w-1/2 p-6">
              ...
              >
                ...
                <path
                  ...
                  fill="#3f3d56"
                />
                <circle cx="193" cy="127.75" r="6" fill="#40C057" />
                <circle cx="208" cy="127.75" r="6" fill="#40C057" />
                <circle cx="223" cy="127.75" r="6" fill="#40C057" />
                <path
                  transform="translate(-11.5 -150.75)"
                ...
                <rect
                  ...
                  opacity=".3"
                />
                <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#40C057" />
                <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#40C057" />
                <path
                  transform="translate(-11.5 -150.75)"
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            <div className="w-full sm:w-1/2 p-6 mt-6">
              ...
              >
                ...
                <circle cx="780.7" cy="309" r="11.968" fill="#40C057" />
                <circle cx="991.17" cy="607.78" r="11.968" fill="#40C057" />
                <circle cx="600.35" cy="480.68" r="11.968" fill="#40C057" />
              </svg>
            </div>
            <div className="w-full sm:w-1/2 p-6 mt-6">
          ...
          <div className="flex">
            <div className="flex-1 md:w-1/3 m-6 bg-white rounded shadow">
              <div className="flex-1 p-10">
                <Image src="https://www.svgrepo.com/show/354113/nextjs-icon.svg" alt="nextjs" />
              </div>
              <div className="px-6 pb-6">
                <div className="text-2xl font-bold text-center">Next.js</div>
            ...
            <div className="flex-1 md:w-1/3 m-6 bg-white rounded shadow">
              ...
              <div className="px-6 pb-6">
                <div className="text-2xl font-bold text-center">Tailwindcss</div>
                <div className="flex items-center justify-center">
                  <a
            ...
            <div className="flex-1 md:w-1/3 m-6 bg-white rounded shadow">
              ...
              <div className="px-6 pb-6">
                <div className="text-2xl font-bold text-center">tRPC</div>
                <div className="flex items-center justify-center">
                  <a
                    href="https://trpc.io/"
                    className="mx-auto lg:mx-0 gradient font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            ...
            <div className="flex-1 md:w-1/3 m-6 bg-white rounded shadow">
              <div className="flex-1 p-10">
                <Image src="https://trpc.io/img/logo.svg" alt="postgresql" />
              </div>
              <div className="px-6 pb-6">
                <div className="text-2xl font-bold text-center">PostgreSQL</div>
                <div className="flex items-center justify-center">
                  <a
      ...
      <section className="bg-gray-100 py-8">
        <div className="container mx-auto px-8">
          <div className="w-full flex flex-col md:flex-row py-6">
            <div className="flex flex-1 gap-2 text-green-600 mb-6">
              <svg
                className="h-8 fill-current inline"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512.005 512.005"
